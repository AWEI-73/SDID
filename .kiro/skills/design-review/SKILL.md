---
name: design-review
description: SDID 設計產物品質審查。接受 Blueprint / Draft / Contract 任一 artifact，自動偵測階段並執行對應 BLOCKER 規則。觸發語：「DESIGN REVIEW」「design-review」「review 這個 draft/blueprint/contract」「跑 gate」「design gate」「這個 draft/blueprint/contract 過了嗎」。結果只有兩種：@PASS 或 @NEEDS_FIX。
---
